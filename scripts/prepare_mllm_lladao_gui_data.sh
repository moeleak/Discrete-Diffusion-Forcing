...
export EASYOCR_TORCH_THREADS="${EASYOCR_TORCH_THREADS:-2}"
export EASYOCR_TORCH_INTEROP_THREADS="${EASYOCR_TORCH_INTEROP_THREADS:-1}"
export OMP_NUM_THREADS="${OMP_NUM_THREADS:-${EASYOCR_TORCH_THREADS}}"
export MKL_NUM_THREADS="${MKL_NUM_THREADS:-${EASYOCR_TORCH_THREADS}}"
export OPENBLAS_NUM_THREADS="${OPENBLAS_NUM_THREADS:-${EASYOCR_TORCH_THREADS}}"
